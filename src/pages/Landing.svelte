...
<div class="main">
   <div class="horizontal-grid">
      <div>
         <h1>Get detailed analytics from your GitHub actions.</h1>
         <h2>
        Know who uses your action, errors, and more to make your action better
        for all
         </h2>
      </div>
      <img
   ...
   <footer class="footer">
      ...
      <a class="link" href="https://github.com/michmich112/gh-action-stats" target="_blank" rel="noreferrer">
      ...
      <a
         class="link"
         href="https://discord.gg/9ZHtFU3CDd"
         target="_blank"
         rel="noreferrer"
      >
         <svg
